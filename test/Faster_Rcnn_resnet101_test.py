...
class Faster_rcnn_resnet_101():
    ...
    def test(self):
        ...
        # file='/home/zhai/PycharmProjects/Demo35/my_Faster_tool/train_5/models/Faster_resnet_101.ckpt-99999'
...
if __name__ == "__main__":
    ...
    config = Config(False, Mean, None, lr=0.001, weight_decay=0.0001, num_cls=20, img_max=1000, img_min=600,
